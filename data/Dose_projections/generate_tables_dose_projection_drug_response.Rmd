...
```{r load_data}
mae <- readRDS('./Zoomed_in_Belva_Cobi_mae.RDS')
```
...
```{r, save_tables}
saveRDS(sa_metrics, './Zoomed_in_Belva_Cobi_sa_metrics.RDS')
saveRDS(combo_list, './Zoomed_in_Belva_Cobi_combo_metrics.RDS')
```
