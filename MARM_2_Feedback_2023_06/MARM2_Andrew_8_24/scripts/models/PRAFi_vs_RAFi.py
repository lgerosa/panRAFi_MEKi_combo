...
Parameter('bind_PRAFi_RAF_kf', 1e-308)
Parameter('bind_PRAFi_RAF_dG', 0.0, nonnegative=False)
Parameter('bind_PRAFi_RAF_phi', 1.0)
Parameter('kbind_RAF_RAF', 1.0)
Parameter('kunbind_RAF_RAF', 1.0)
...
Observable('bound_PRAFi', PRAFi(raf=ANY))
Observable('free_PRAFi', PRAFi(raf=None))
#Observable('tMEK', MEK())
...
Expression('bound_CRAF_obs', bound_CRAF/tCRAF)
...
Rule('CRAF_and_CRAF_bind_and_dissociate', CRAF(raf=None) + CRAF(raf=None) | CRAF(raf=1) % CRAF(raf=1), kbind_RAF_RAF, kunbind_RAF_RAF)
