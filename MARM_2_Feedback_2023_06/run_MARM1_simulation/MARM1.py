...
Parameter('m_Da_EGF_p', 6200.0)
Parameter('RAFi_0', 0.0)
Parameter('MEKi_0', 0.0)
Parameter('EGF_0', 0.0)
Parameter('EGF_conv', 6.02214085854916e+23)
...
Expression('m_Da_EGF', m_Da_EGF_p)
Expression('initRAFi', RAFi_0)
Expression('initMEKi', MEKi_0)
Expression('initEGF', EGF_0*EGF_conv/(m_Da_EGF*N_Avogadro))
...
Expression('synthesize_ERKphosphop_EGFR_ksyn', 1000000.0*EGFR_crispr*EGFR_eq*synthesize_ERKphosphop_EGFR_kdeg/(N_Avogadro*volume))
...
Expression('synthesize_ERKphosphop_SPRY_ksyn', 1000000.0*SPRY_eq*synthesize_ERKphosphop_SPRY_kdeg/(N_Avogadro*volume))
...
Expression('synthesize_ERKphosphop_DUSP_ksyn', 1000000.0*DUSP_eq*synthesize_ERKphosphop_DUSP_kdeg/(N_Avogadro*volume))
