# BRAF V600E fit MARM2 manually curated to to resemble RAS Q61 Melanoma and remove Signaling upstream of SOS (e.g. EGFR, GRB2, SPRY)
...
#Observable('tBRAF600E', BRAF(AA600='V'))
...
Expression('gtpRAS_percent', gtpRAS/tRAS*100)
Expression('pCRAF_percent', pCRAF/tCRAF*100)
Expression('Bound_CRAF_percent', bound_CRAF/tCRAF*100)
Expression('Bound_RAF_percent', bound_CRAF/tCRAF*100)
Expression('Active_CRAF_percent', active_dimer_CRAF/tCRAF*100)
Expression('Active_RAF_percent', active_dimer_CRAF/tCRAF*100)
...
#Initial(BRAF(AA600='V', RBD=None, mek=None, raf=None, rafi=None, T753='u') ** CP, initBRAF)
